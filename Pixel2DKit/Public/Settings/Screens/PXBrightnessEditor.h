...
#include "PXBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class PIXEL2DKIT_API UPXBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UPXBrightnessEditor(const FObjectInitializer& Initializer);
