...
#include "PXSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class PIXEL2DKIT_API UPXSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UPXSafeZoneEditor(const FObjectInitializer& Initializer);
