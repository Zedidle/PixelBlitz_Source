 ...
 */
UCLASS()
class UPXSettingsLocal : public UGameUserSettings
{
	GENERATED_BODY()
...
public:
	...
	DECLARE_EVENT(UPXSettingsLocal, FLatencyFlashInidicatorSettingChanged);
	UFUNCTION()
	...
	DECLARE_EVENT(UPXSettingsLocal, FLatencyStatEnabledSettingChanged);
