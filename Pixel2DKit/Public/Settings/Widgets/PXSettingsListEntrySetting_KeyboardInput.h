...
#include "PXSettingsListEntrySetting_KeyboardInput.generated.h"
...
class UPXButtonBase;
class UPXSettingKeyboardInput;
class UObject;

UCLASS()
class PIXEL2DKIT_API UPXSettingsListEntrySetting_KeyboardInput : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	TObjectPtr<UPXSettingKeyboardInput> KeyboardInputSetting;
...
private:	// Bound Widgets
	...
	TObjectPtr<UPXButtonBase> Button_PrimaryKey;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<UPXButtonBase> Button_SecondaryKey;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<UPXButtonBase> Button_Clear;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<UPXButtonBase> Button_ResetToDefault;
};
