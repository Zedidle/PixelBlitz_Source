...
#include "PXSettingValueDiscrete_OverallQuality.h"

#include "Engine/Engine.h"
#include "Settings/PXSettingsLocal.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PXSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "PXSettings"

UPXSettingValueDiscrete_OverallQuality::UPXSettingValueDiscrete_OverallQuality()
{
}

void UPXSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();

	UPXSettingsLocal* UserSettings = UPXSettingsLocal::Get();
...
void UPXSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UPXSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UPXSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UPXSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UPXSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UPXSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UPXSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UPXSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
