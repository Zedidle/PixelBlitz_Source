...
#include "PXSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PXSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "PX"

static const int32 SettingSystemDefaultLanguageIndex = 0;

UPXSettingValueDiscrete_Language::UPXSettingValueDiscrete_Language()
{
}

void UPXSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UPXSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UPXSettingValueDiscrete_Language::OnApply()
{
...
void UPXSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UPXSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UPXSettingsShared* Settings = CastChecked<UPXLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UPXSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UPXSettingsShared* Settings = CastChecked<UPXLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UPXSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UPXSettingsShared* Settings = CastChecked<UPXLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UPXSettingValueDiscrete_Language::GetDiscreteOptions() const
{
