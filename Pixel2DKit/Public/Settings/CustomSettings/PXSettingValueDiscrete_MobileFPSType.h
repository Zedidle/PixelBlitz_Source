...
#include "PXSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class UPXSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UPXSettingValueDiscrete_MobileFPSType();
