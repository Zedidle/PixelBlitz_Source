...
#include "PXSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UPXSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UPXSettingValueDiscreteDynamic_AudioOutputDevice() = default;
