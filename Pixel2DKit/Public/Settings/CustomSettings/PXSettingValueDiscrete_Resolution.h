...
#include "PXSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UPXSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UPXSettingValueDiscrete_Resolution();
