...
#define PX_DOREPLIFETIME_ATTRIBUTE(PropertyName) \
	DOREPLIFETIME_CONDITION_NOTIFY(UPXAttributeSet, PropertyName, COND_None, REPNOTIFY_Always)

	PX_DOREPLIFETIME_ATTRIBUTE(HP);
	PX_DOREPLIFETIME_ATTRIBUTE(EP);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicMaxHP);
	PX_DOREPLIFETIME_ATTRIBUTE(CurMaxHP);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicHPRecoverValue);
	PX_DOREPLIFETIME_ATTRIBUTE(CurHPRecoverValue);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicMaxEP);
	PX_DOREPLIFETIME_ATTRIBUTE(CurMaxEP);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicEPRecoverValue);
	PX_DOREPLIFETIME_ATTRIBUTE(CurEPRecoverValue);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicSpeed);
	PX_DOREPLIFETIME_ATTRIBUTE(CurSpeed);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicAcceleration);
	PX_DOREPLIFETIME_ATTRIBUTE(CurAcceleration);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicSpeedDownReist);
	PX_DOREPLIFETIME_ATTRIBUTE(CurSpeedDownReist);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicDashSpeed);
	PX_DOREPLIFETIME_ATTRIBUTE(CurDashSpeed);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicDashCD);
	PX_DOREPLIFETIME_ATTRIBUTE(CurDashCD);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicDamagePlusAfterDash);
	PX_DOREPLIFETIME_ATTRIBUTE(CurDamagePlusAfterDash);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicSight);
	PX_DOREPLIFETIME_ATTRIBUTE(CurSight);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicSightReductionResist);
	PX_DOREPLIFETIME_ATTRIBUTE(CurSightReductionResist);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicMaxJumpCount);
	PX_DOREPLIFETIME_ATTRIBUTE(CurMaxJumpCount);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicJumpSpeed);
	PX_DOREPLIFETIME_ATTRIBUTE(CurJumpSpeed);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicJumpMaxHoldTime);
	PX_DOREPLIFETIME_ATTRIBUTE(CurJumpMaxHoldTime);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicAirControl);
	PX_DOREPLIFETIME_ATTRIBUTE(CurAirControl);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicAttackValue);
	PX_DOREPLIFETIME_ATTRIBUTE(CurAttackValue);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicAttackCD);
	PX_DOREPLIFETIME_ATTRIBUTE(CurAttackCD);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicRepelValue);
	PX_DOREPLIFETIME_ATTRIBUTE(CurRepelValue);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicRepelResist);
	PX_DOREPLIFETIME_ATTRIBUTE(CurRepelResist);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicGravityScale);
	PX_DOREPLIFETIME_ATTRIBUTE(CurGravityScale);
	PX_DOREPLIFETIME_ATTRIBUTE(BasicBodySizeScale);
	PX_DOREPLIFETIME_ATTRIBUTE(CurBodySizeScale);

#undef PX_DOREPLIFETIME_ATTRIBUTE
}
