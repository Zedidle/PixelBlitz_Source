...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PXPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "PXCheats"

UPXPlatformEmulationSettings::UPXPlatformEmulationSettings()
{
}

FName UPXPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UPXPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UPXPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UPXPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UPXPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UPXPlatformEmulationSettings::PostInitProperties()
{
...
void UPXPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UPXPlatformEmulationSettings::ApplySettings()
{
...
void UPXPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UPXPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UPXPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UPXPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
