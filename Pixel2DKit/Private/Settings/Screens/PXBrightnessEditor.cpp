...
#include "Settings/Screens/PXBrightnessEditor.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PXBrightnessEditor)
...
UPXBrightnessEditor::UPXBrightnessEditor(const FObjectInitializer& Initializer)
	: Super(Initializer)
{
...
void UPXBrightnessEditor::NativeOnInitialized()
{
	Super::NativeOnInitialized();
	Switcher_SafeZoneMessage->SetActiveWidget(RichText_Default);
}

void UPXBrightnessEditor::NativeOnActivated()
{
...
bool UPXBrightnessEditor::ExecuteActionForSetting_Implementation(FGameplayTag ActionTag, UGameSetting* InSetting)
{
...
FReply UPXBrightnessEditor::NativeOnAnalogValueChanged(const FGeometry& InGeometry, const FAnalogInputEvent& InAnalogEvent)
{
...
FReply UPXBrightnessEditor::NativeOnMouseWheel(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void UPXBrightnessEditor::HandleDoneClicked()
{
